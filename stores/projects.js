			...
			modalContent: {
				...
				files: [
					...
					},
					{
						...
						p: 'My <em>‘Workout APP’</em> took a simple interface from the forms and created more than just a short answer for the user. I often have to remember the main body focus for my workout and the types of sets needed. This app is a simple way to create short lists of workouts dedicated to the muscle group. It was built using local storage and JavaScript class methods to generate app functionality, while using imports and exports to create templates for each page.',
					},
					{
						...
						p: 'The <em>‘Bill Split APP’</em> was inspired by a night out with friends and the effort it took to even divide the bill. It has an interface with more personality and functionality. I used similar routing in Vanilla JavaScript to create multiple page templates.',
					},
					{
						title: 'Dunkin',
						git: 'https://github.com/JesseDevs/super-shot',
				...
				files: [
					{
						...
						p: 'In the ‘Layouts’ tab, you can check out some layout designs. This page is a metaphor for a garden because, just like in a garden, you need to continue watering your skills to create a beautiful piece of art. These layouts originate from images that were then crafted into templates that can be reused with different data.',
					},
					{
